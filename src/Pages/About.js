...
function About() {
    return (
        <div className="About">
            ...
            <img src={require('../resources/profile.jpg')} width="300px" alt='profilepic' />
            <h2>Josh Tillson</h2>
            <h4> Hello!! <br /> <br />
                ...
                Feel free to reach out to me on <a href="https://www.linkedin.com/in/joshtillson/">Linkedin</a>
            </h4>
            <h4>
